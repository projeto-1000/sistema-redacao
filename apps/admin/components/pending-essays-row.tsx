    ...
    <div className="divide-y divide-slate-100">
      ...
      >
        ...
        <div className="min-w-0 mt-2 xl:mt-0">
          <span className="xl:hidden text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-1">
            Tema
          </span>
          <p className="text-sm font-medium leading-snug line-clamp-2 break-words" title={essay.title}>
            {essay.title}
          </p>
        </div>

        <div className="flex xl:justify-center shrink-0">
        ...
        <div className="flex justify-end min-w-0">
          <Button
            ...
            className="rounded-2xl font-bold shadow-sm h-10 shrink-0 whitespace-nowrap leading-normal transition-transform"
